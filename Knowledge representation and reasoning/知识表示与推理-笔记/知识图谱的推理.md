...
一般到特殊![[290777ba2116170088eb8f9240716002.png]]

#### Inductive Reasoning——归纳推理

归纳泛化 & 统计推论 -> 从特殊到一般
![[775c49a997c0fbb98bcace38c41a99dd.png]]
![[be6546e3f130bd5616bf0d7ac7137e0e.png]]

#### Abductive Reasoning——溯因推理

从结果到原因，通过现象推测原因。
![[2f5b2deb987cedf4912c9615a8c920c8.png]]

#### Analogical Reasoning——类比推理

特殊到特殊
![[72b4f5e1a9445bf6b28f97d3ab93ef2f.png]]

## 知识图谱推理

用KG推理将问题简化为事实预测或关系推理。
![[a8a8ab81356c308707257736a4339902.png]]![[cd127dbf15f184de38c3bc5b6aec6a46.png]]


基于符号表示的推理： Deductive Reasoning with Ontological Axioms
显式的路径特征/规则可直接用于对推理结果进行解释
![[97255cad32452e565d7ccf8db3014870.png]]![[2da49913ad81edadca3fdf243b5cba51.png]]
基于向量表示的推理： Inductive Reasoning with Representation Learning
图神经网络可以为图谱推理获得更多的图结构方面的特征，但图谱稀疏性问题更加突出
![[eafd51e38cbeb20b8de2fe8380b7acbb.png]]

小结：符号逻辑与表示学习的融合
![[ed877c8d9269a29c6d479892f0bbd23e 1.png]]
...
- OWL本体推理：实例检测推理—主要用于计算符合某个概念或关系定义的所有实例。![[dc24357a15efa104bd88c37f2a0f9f20.png]]
...
![[1719468566958.png]]
#### 基于规则的推理
![[996ee8e867bd88e64b2bf7acb46f2ab3.png]]
Datalog语法
![[fce37df0d7fdef479bcdcfc0862ccf70.png]]
基于产生式规则的推理
...
产生式系统的组成
- 事实集合 (Working Memory)![[8f69a1c93dab7df75d40a1db2fd5442a.png]]
- 产生式/规则集合![[f519817a8f14478d7f5b8d76929f027a.png]]
	- ![[b85e0ce494f81092598ec07bbbea4a6c.png]]
	- ![[ba0f95c9b057d405697d50e8a3eb42ca.png]]
- 推理引擎![[3d8463fe745cac516611ebaa12330be6.png]]
	- 模式匹配![[00e3b35db6b2fb62d8dd99e9358d25ca.png]]
		- RETE算法，将产生式的LHS组织成判别网络形式。其核心思想是用分离的匹配项构造匹配网络，同时缓存中间结果。以空间换时间。![[1719470857003.png]]
...
![[315821de1c99c44cbafd4e137e493bb6.png]]
**TransE——Translating Embeddings for Modeling Multi-relational Data**
![[e6ee3c750c93f5e699d0a387063e2f71.png]]
...
![[31552587b010f258450d4662d1994050.png]]
...
![[222417ee0023af01a1bf998a9c6bec32.png]]
...
![[bb7d76a7152bb1968580b6c2ad3ebae3.png]]
...
![[73c906bb966a149cf7a93f4d2a782e81.png]]
...
![[e2d2fdd1e8ab2220cd2bc1c93079116d.png]]

**Analogy**
利用类比推理的思想做知识图谱推理
![[a55016bc2b0f8b4162474370ed2dc0da.png]]
**RotaE**
- 旋转建模
- 选择当前最难区分的负样本
![[f63c56429146b0e046d036d8b9ad1489.png]]
...
![[c1ffa7b408bdee88d8b723a5b2816d2e.png]]
![[aca858329fe8811a2f3cdff3fa4d6263.png]]

**多模态类比推理**
![[2af4c72fb884b243a5d1b96b2c3fe426.png]]
#### 基于规则学习的知识图谱推理
![[7c7a0926d4106acf313ab2ecbe885044.png]]
**PRA—Path Ranking Algorithm**
路径排序打分加权 -> 逻辑回归
![[6451eb156debf3649c5d6948a025338a.png]]

可微规则学习：NeuralLP

- 借助表示学习来学习规则![[64a01d443d20d5c5048779f242074c36.png]]


- 一阶谓词逻辑的右部可以看成`规则置信度 * 规则M_r的连续乘积`的累和，推理过程即可视作转移![[9f48a4872cd7e1a5e4e009d87ed325cc.png]]
- 但是这样规定规则长度均为T，因此提出注意力机制选择合适的长度![[d44bfd6676b3aed464270005b6e0147d.png]]
- NeuralLP会学到置信度很⾼的错误规则，所以DRUM引⼊了confidence value tensor来解决这个问题。

**规则与嵌入表示的迭代学习：IterE**

![[10f24088f07cbeb0b02855906b8bc4e8.png]]
#### Ontology Embedding—本体概念层推理
![[beb74ceb59834fcc3fa724f919a7c33a.png]]

EL embedding — 全部转为包含关系
![[90f626a091dd7be9c02f69eba8b017f2.png]]
核心是两个映射函数：f(x)和r(x)

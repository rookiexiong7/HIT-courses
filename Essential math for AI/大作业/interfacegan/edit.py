...
def parse_args():
  ...
  parser.add_argument('--model_name',default='pggan_celebahq', type=str,
                      choices=list(MODEL_POOL),
                      help='Name of the model for generation. (required)')
  parser.add_argument('--output_dir', default='results/pggan_celebahq_gender_editing',type=str, 
                      help='Directory to save the output results. (required)')
  parser.add_argument('--boundary_path',default='boundaries/pggan_celebahq_gender_boundary.npy', type=str, 
                      help='Path to the semantic boundary. (required)')
  parser.add_argument('--input_latent_codes_path', type=str, default='',
